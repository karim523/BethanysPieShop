...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20231016192918_NewBethanysPieShopTables")]
    partial class NewBethanysPieShopTables
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BethanysPieShop.InventoryManagement.Domain.OrderManagment.OrderPurchase", b =>
                {
                    b.HasOne("BethanysPieShop.InventoryManagement.Domain.SupplierManagement.Supplier", null)
                        .WithOne()
                        .HasForeignKey("BethanysPieShop.InventoryManagement.Domain.OrderManagment.OrderPurchase", "SupplierId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
